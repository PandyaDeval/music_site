...
else
{
  if($pass==$conf)
  {
    ...
    {
   		$ql= "create table users(id INT AUTO_INCREMENT,name VARCHAR(20),username VARCHAR(20),email VARCHAR(20),password VARCHAR(20),gender VARCHAR(20))";
   		if(mysqli_query($conn,$ql))
   		{
    		if (mysqli_query($conn,$sql))
    		{
    			   echo "<script>alert('Registration succesful!');location='home.php';</script>";
